...
#include "telemanipulator/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Pivot_type_support_symbol_names_t _Pivot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, telemanipulator, msg, Pivot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, telemanipulator, msg, Pivot)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_telemanipulator
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, telemanipulator, msg, Pivot)() {
  return &::telemanipulator::msg::rosidl_typesupport_c::Pivot_message_type_support_handle;
}
