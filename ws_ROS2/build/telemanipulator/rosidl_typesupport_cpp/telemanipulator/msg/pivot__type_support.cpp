...
static const _Pivot_type_support_symbol_names_t _Pivot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, telemanipulator, msg, Pivot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, telemanipulator, msg, Pivot)),
  }
};
...
{
  return &::telemanipulator::msg::rosidl_typesupport_cpp::Pivot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, telemanipulator, msg, Pivot)() {
  return get_message_type_support_handle<telemanipulator::msg::Pivot>();
}
