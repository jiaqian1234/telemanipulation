...
#include "pivot_msg/msg/detail/pivot__rosidl_typesupport_fastrtps_c.h"
...
using _Pivot__ros_msg_type = pivot_msg__msg__Pivot;
...
static uint32_t _Pivot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pivot_msg__msg__Pivot(
...
{
  return max_serialized_size_pivot_msg__msg__Pivot(
    full_bounded, 0);
}
