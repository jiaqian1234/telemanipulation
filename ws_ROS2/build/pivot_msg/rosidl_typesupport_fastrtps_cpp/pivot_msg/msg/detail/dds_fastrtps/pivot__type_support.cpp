...
#include "pivot_msg/msg/detail/pivot__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const pivot_msg::msg::Pivot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pivot_msg::msg::Pivot *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_pivot_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<pivot_msg::msg::Pivot>()
{
  return &pivot_msg::msg::typesupport_fastrtps_cpp::_Pivot__handle;
}
