...
bool telemanipulator__msg__pivot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("telemanipulator.msg._pivot.Pivot", full_classname_dest, 32) == 0);
  }
  telemanipulator__msg__Pivot * ros_message = _ros_message;
  {  // pan
...
PyObject * telemanipulator__msg__pivot__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("telemanipulator.msg._pivot");
